...
%prep
%setup -q -n filelight-21.08.2
cd %{_builddir}/filelight-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634353824
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/filelight-21.08.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/filelight/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/filelight-21.08.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/filelight/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/filelight-21.08.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/filelight/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/filelight-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/filelight/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/filelight-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/filelight/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
