...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/filelight-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/filelight-19.12.1.tar.xz.sig
...
%prep
%setup -q -n filelight-19.12.1
cd %{_builddir}/filelight-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578600752
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/filelight-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/filelight/4b345b7da7f2ee919adfb971f728fcc666653c7e
cp %{_builddir}/filelight-19.12.1/COPYING-DOCS %{buildroot}/usr/share/package-licenses/filelight/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang filelight
