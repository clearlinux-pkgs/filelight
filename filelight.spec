...
Version  : 23.08.2
Release  : 60
URL      : https://download.kde.org/stable/release-service/23.08.2/src/filelight-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/filelight-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/filelight-23.08.2.tar.xz.sig
...
%prep
%setup -q -n filelight-23.08.2
cd %{_builddir}/filelight-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697249600
mkdir -p clr-build
pushd clr-build
