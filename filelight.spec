...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/filelight-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/filelight-24.12.0.tar.xz.sig
...
%setup -q -n filelight-24.12.0
cd %{_builddir}/filelight-24.12.0
pushd ..
cp -a filelight-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735202309
mkdir -p clr-build
pushd clr-build
